        ...
        <div className="relative z-10 max-w-4xl px-6 text-center mx-auto">
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              {/* === IN SPORTS — COLORFUL LETTERS === */}
              <span className="font-extrabold">
                {"in Sports".split("").map((char, i) => (
                  <span
                    key={i}
                    style={{
              ...
              {/* === STANDS — WHITE === */}
              <span className="text-white">Stands<br /></span>

              {/* ==== UNDERLINE (RAINBOW BAR) ==== */}
              <span
                className="
          ...
          <motion.p
            ...
            "
          >
            Turkey's most innovative social responsibility project, aiming to encourage children
            to engage in sports and spread a healthy sports culture by creating safe stadium
            seating areas.
          </motion.p>
